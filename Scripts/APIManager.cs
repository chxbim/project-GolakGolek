...
public class APIManager : MonoBehaviour
{
    ...
    // CartEndpoint belum tersedia di backend JTV.
    // Nanti isi URL-nya setelah dikonfirmasi ke tim backend.
    // Contoh: private string CartEndpoint => $"{baseUrl}/cart";
    private string CartEndpoint => $"{baseUrl}/cart";
